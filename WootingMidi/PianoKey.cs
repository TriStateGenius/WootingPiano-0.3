...
namespace WootingMidi
{
    ...
    public class NoteKey
    {
        ...
        public RawMidiMessage MidiNoteOn()
        {
            ...
            var hi = (byte)(NoteId & 0x7F);
            var lo = (byte)((uint)(Velocity * 127.0) & 0x7F);
        ...
        public RawMidiMessage Submit(dynamic currval)
        {
            Velocity = Min(Max(Max(0, currval - Pressure / Velocity) * 2, Velocity * 0.1), E);
            Velocity = currval;
